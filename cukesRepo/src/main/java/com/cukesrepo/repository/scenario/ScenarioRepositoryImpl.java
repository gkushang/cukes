...
public class ScenarioRepositoryImpl implements ScenarioRepository {
    ...
    private void _insertScenarios(String projectName, String featureId, List<Scenario> gitScenarios) {

        List<Scenario> approvedScenarios = _getApprovedAndOrWithCommentsScenariosFromDB(projectName, featureId);
    ...
    public List<Scenario> getApprovedScenariosFromDB(String projectName, String featureId) {
        ...
        query = new Query
                (
                        Criteria.
                                where(Scenario.PROJECTNAME).is(projectName).
    ...
    public List<Scenario> fetchScenarios(Project project, String featureId) throws ProjectNotFoundException, ScenariosNotFoundException {
        ...
        _insertScenarios(project.getName(), featureId, gitScenarios);

        return _mongoTemplate.find(_queryToFindAllScenarios(project.getName(), featureId), Scenario.class);

    }

    public void approveScenario(String projectName, String featureId, String scenarioNumber) throws ScenariosNotFoundException {

        LOG.info("Approve Scenario '{}' for Project '{}' and Feature '{}'",scenarioNumber, projectName, featureId);
        ...
        LOG.info("Scenario was approved for Project '{}' and Feature '{}'",scenarioNumber, projectName, featureId);
    }

    @Override
    public void addComment(String projectName, String featureId, String scenarioNumber, String comment) {

        LOG.info("Add comment '{}' to Scenario '{}' for Project '{}' and Feature '{}'", comment, scenarioNumber, projectName, featureId);
        ...
        _mongoTemplate.updateFirst
                (
                        _queryToFindOneScenarioByNumber
                                (
                                        projectName, featureId, scenarioNumber
                                ),
    ...
    private List<Scenario> _getApprovedAndOrWithCommentsScenariosFromDB(String projectName, String featureId) {
